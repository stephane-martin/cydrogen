...
from ._datastructs import EncryptedMessage, MessageType

class BytearrayBuilder:
    def __init__(self) -> None: ...
    def add(self, data: Buffer) -> None: ...
    def add_encrypted_message(self, msg: EncryptedMessage) -> None: ...
...
class ReadBuffers:
    ...
    def consume_server_ack(self) -> memoryview | None: ...
