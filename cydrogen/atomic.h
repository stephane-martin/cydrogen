 ...
 * __STDC_NO_ATOMICS__.  Versions prior to 4.7 didn't set
...
typedef atomic_uint_fast64_t psnip_atomic_uint64;
typedef atomic_int_fast32_t psnip_atomic_int32;
typedef atomic_uint_fast32_t psnip_atomic_uint32;
...
typedef _Atomic psnip_uint64_t psnip_atomic_uint64;
typedef _Atomic psnip_int32_t psnip_atomic_int32;
typedef _Atomic psnip_uint32_t psnip_atomic_uint32;
...
typedef psnip_uint64_t psnip_atomic_uint64;
typedef psnip_int32_t psnip_atomic_int32;
typedef psnip_uint32_t psnip_atomic_uint32;
#endif
...
typedef unsigned long long volatile psnip_atomic_uint64;
typedef long volatile psnip_atomic_int32;
typedef unsigned long volatile psnip_atomic_uint32;
...
#define psnip_atomic_uint64_store(object, desired)  \
  psnip_atomic_int64_store(object, desired)
#define psnip_atomic_int32_compare_exchange(object, expected, desired)  \
  psnip_atomic_int64_compare_exchange(object, expected, desired)
#define psnip_atomic_int32_add(object, operand) \
  psnip_atomic_int64_add(object, operand)
#define psnip_atomic_uint64_add(object, operand) \
  psnip_atomic_int64_add(object, operand)
#define psnip_atomic_uint32_add(object, operand) \
  psnip_atomic_int64_add(object, operand)
#define psnip_atomic_int32_sub(object, operand) \
